...
const AIChatBox = () => {
  ...
  return (
    <div className=" max-w-3xl mx-auto p-4 rounded-2xl  text-white flex flex-col">
      ...
      <div className="relative z-10 p-2 h-full flex flex-col">
        {/* Header */}
        <div className="mb-2">
          <h2 className="text-2xl font-bold text-blue-400 mb-2 drop-shadow-lg">
            Ask the AI Coach
          </h2>
        ...
        {/* Messages Container */}
        <div className="flex-1 mb-6 bg-white/10 backdrop-blur-md rounded-xl border border-blue-500 shadow-inner overflow-y-auto max-h-[400px]">
